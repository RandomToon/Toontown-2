...
from toontown.building import DistributedDeadlyVPElevatorAI
...
from toontown.suit import DistributedDeadlySellbotBossAI
...
class SellbotHQAI(CogHQAI.CogHQAI):
    def __init__(self, air):
        CogHQAI.CogHQAI.__init__(
            ...
            DistributedDeadlyVPElevatorAI.DistributedDeadlyVPElevatorAI,
            DistributedDeadlySellbotBossAI.DistributedDeadlySellbotBossAI)
