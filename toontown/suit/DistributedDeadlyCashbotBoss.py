...
class DistributedDeadlyCashbotBoss(DistributedCashbotBoss):
    notify = directNotify.newCategory('DistributedDeadlyCashbotBoss')
    ...
    def __init__(self, cr):
        ...
        self.bossMaxDamage = ToontownGlobals.DeadlyCashbotBossMaxDamage

    def announceGenerate(self):
        DistributedCashbotBoss.announceGenerate(self)

        self.setName(TTLocalizer.DeadlyCashbotBossName)
    ...
    def makeBossFleeMovie(self):
        hadEnough = TTLocalizer.DeadlyCashbotBossHadEnough
        outtaHere = TTLocalizer.DeadlyCashbotBossOuttaHere
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        track = Sequence(
            ...
            Func(rToon.setChatAbsolute, TTLocalizer.DeadlyResistanceToonWelcome, ChatGlobals.CFSpeech),
            Wait(3),
                ...
                Sequence(
                    ...
                    Parallel(
                        ...
                        Parallel(
                            ...
                            Func(self.setChatAbsolute, TTLocalizer.DeadlyCashbotBossDiscoverToons2, ChatGlobals.CFSpeech),
                            Wait(4),
                            Func(self.clearChat),
                            ...
                            Func(rToon.setChatAbsolute, TTLocalizer.DeadlyResistanceToonKeepHimBusy, ChatGlobals.CFSpeech),
                            Wait(1),
    ...
    def makePrepareBattleThreeMovie(self, delayDeletes):
        ...
        track = Sequence(
            ...
            Func(rToon.setChatAbsolute, TTLocalizer.DeadlyResistanceToonWatchThis, ChatGlobals.CFSpeech),
            Wait(2),
            Func(rToon.clearChat),
            Func(base.camera.setPosHpr, 105, -326, 20, -45.3, 11, 0),
            Func(self.setChatAbsolute, TTLocalizer.DeadlyCashbotBossGetAwayFromThat, ChatGlobals.CFSpeech),
            Wait(2),
            Func(self.clearChat),
            ...
            Wait(4),
            Func(rToon.setChatAbsolute, TTLocalizer.DeadlyResistanceToonCraneInstructions3, ChatGlobals.CFSpeech),
            Wait(4),
            Func(rToon.setChatAbsolute, TTLocalizer.DeadlyResistanceToonCraneInstructions4, ChatGlobals.CFSpeech),
            Wait(4),
            Func(rToon.clearChat),
