...
from toontown.suit import DeadlySellbotBossGlobals
...
class DistributedDeadlySellbotBossAI(DistributedSellbotBossAI):
    notify = directNotify.newCategory('DistributedDeadlySellbotBossAI')
    ...
    def zapToon(self, x, y, z, h, p, r, bpx, bpy, attackCode, timestamp):
        ...
        if toon:
            ...
            damage = DeadlySellbotBossGlobals.getDamageFromAttackCode(attackCode)
