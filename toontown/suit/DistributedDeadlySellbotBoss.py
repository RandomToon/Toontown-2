...
class DistributedDeadlySellbotBoss(DistributedSellbotBoss):
    notify = directNotify.newCategory('DistributedDeadlySellbotBoss')
    ...
    def announceGenerate(self):
        ...
        self.setName(TTLocalizer.DeadlySellbotBossName)
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        promoteDoobers = TTLocalizer.DeadlyBossCogPromoteDoobers
        doobersAway = TTLocalizer.DeadlyBossCogDoobersAway
        welcomeToons = TTLocalizer.DeadlyBossCogWelcomeToons
        promoteToons = TTLocalizer.DeadlyBossCogPromoteToons
        discoverToons = TTLocalizer.DeadlyBossCogDiscoverToons
        attackToons = TTLocalizer.DeadlyBossCogAttackToons
        interruptBoss = TTLocalizer.DeadlyCagedToonInterruptBoss
        rescueQuery = TTLocalizer.DeadlyCagedToonRescueQuery
    ...
    def enterPrepareBattleThree(self):
        ...
        self.cagedToon.setLocalPageChat(TTLocalizer.DeadlyCagedToonPrepareBattleThree, 1)
    ...
    def _DistributedSellbotBoss__talkAboutPromotion(self, speech):
        if self.prevCogSuitLevel < ToontownGlobals.MaxCogSuitLevel:
            ...
            if self.prevCogSuitLevel != maxCogSuitLevel:
                speech += TTLocalizer.DeadlyCagedToonLevelPromotion
    ...
    def _DistributedSellbotBoss__makeCageOpenMovie(self):
        speech = TTLocalizer.DeadlyCagedToonThankYou
