...
DeadlyCashbotBossName = 'Deadly C. F. O.'
...
DeadlyCashbotBossHadEnough = "That's it. I've had enough of this!"
CashbotBossOuttaHere = "I've got a train to catch!"
DeadlyCashbotBossOuttaHere = "Time to visit The Chairman to report my defeat. I'm out of here, Toons! "
...
DeadlyResistanceToonWelcome = "Hey, welcome back!  Maybe we can find some vulnerabilities in the main vault!  This way!"
ResistanceToonTooLate = "Blast it!  We're too late!"
DeadlyResistanceToonTooLate = "Drat!  Late yet again!"
CashbotBossDiscoverToons1 = 'Ah-HAH!'
CashbotBossDiscoverToons2 = 'I thought I smelled something a little toony in here!  Imposters!'
DeadlyCashbotBossDiscoverToons2 = "Well, well, well...  Look who we have here!  You Toons don't give up, do you?"
ResistanceToonKeepHimBusy = "Keep him busy!  I'm going to set a trap!"
DeadlyResistanceToonKeepHimBusy = "Keep him busy while I get these cranes operating again!"
ResistanceToonWatchThis = 'Watch this!'
DeadlyResistanceToonWatchThis = 'Just in time!'
CashbotBossGetAwayFromThat = 'Hey!  Get away from that!'
DeadlyCashbotBossGetAwayFromThat = 'Hey!  I thought you were gone?!'
...
DeadlyResistanceToonCraneInstructions3 = "Grab a goon with a magnet and hit the C.E.O. right in the head."
ResistanceToonCraneInstructions4 = 'Once his helmet is gone, grab a disabled goon and hit him in the head!'
DeadlyResistanceToonCraneInstructions4 = "You can disable the goons by stepping on them.  This will make them easier to pick up.  Beware though, the C.E.O. can spawn bigger and stronger goons to protect him!"
...
ElevatorDeadlyCashBotBoss = 'Deadly Cashbot Vault'
